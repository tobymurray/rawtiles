...
if __package__ in (None, ""):
    ...
    from generators import (
        ...
        golden_png_to_pack_1tile,
        golden_png_to_pack_5tiles,
        golden_pyramid,
        ...
        neg_23a_singleimage_tilecount,
        neg_23e_singleimage_zoomoffsets_leak,
        neg_24_crc_flipped,
        neg_25_index_offset_296,
        neg_26a_name_payload_empty,
        neg_26b_name_tag_overruns,
        neg_27_tag_first_byte,
        neg_28_tag_nonprintable,
        neg_29a_duplicate_attr,
        neg_29b_duplicate_name_locale,
        neg_31_quadtree_xy,
        neg_32_tile_placement,
        neg_33_padding_nonzero,
        neg_34_affn_length,
...
GENERATORS = [
    ...
    *neg_23_singleimage_shape.FIXTURES,
    neg_23a_singleimage_tilecount,
    *neg_23e_singleimage_zoomoffsets_leak.FIXTURES,
    neg_24_crc_flipped,
    neg_25_index_offset_296,
    neg_26a_name_payload_empty,
    *neg_26b_name_tag_overruns.FIXTURES,
    neg_27_tag_first_byte,
    neg_28_tag_nonprintable,
    neg_29a_duplicate_attr,
    neg_29b_duplicate_name_locale,
